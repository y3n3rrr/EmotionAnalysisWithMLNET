...
namespace EmotionAnalysisWithMLNET.Helper
{
    public class ModelBuilder
    {
        ...
        public void BuildAndTrain(IEnumerable<ImageData> imageSet, IEnumerable<ImageData> testSet)
        {
            ...
            var dataProcessPipeline = mlContext.Transforms.Conversion.MapValueToKey(outputColumnName: LabelAsKey, inputColumnName: "Label")
                            .Append(mlContext.Transforms.LoadImages(outputColumnName: "image_object", imageFolder: imagesFolder, inputColumnName: nameof(ImageData.ImagePath)))
            ...
            ConsoleHelper.ConsoleWriteHeader("Training the ML.NET classification model");
            ...
            ConsoleHelper.ConsoleWriteHeader("Create Predictions and Evaluate the model quality");
            ...
            ConsoleHelper.ConsoleWriteHeader("*** Showing all the predictions ***");
            ...
            predictions.ForEach(pred => ConsoleHelper.ConsoleWriteImagePrediction(pred.ImagePath, pred.Label, pred.PredictedLabelValue, pred.Score.Max()));
            ...
            ConsoleHelper.ConsoleWriteHeader("Classification metrics");
            ...
            ConsoleHelper.ConsoleWriteHeader("Save model to local file");
